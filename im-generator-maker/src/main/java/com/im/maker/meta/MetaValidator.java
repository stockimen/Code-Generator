...
public class MetaValidator {
    ...
    private static void validAndFillMetaRoot(Meta meta) {
        // 校验与填充默认值
        String name = StrUtil.blankToDefault(meta.getName(), "defaultName");
        String description = StrUtil.emptyToDefault(meta.getDescription(), "defaultDescription");
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "defaultAuthor");
        String version = StrUtil.emptyToDefault(meta.getVersion(), "1.0");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.im");
    ...
    private static void validAndFillModelConfig(Meta meta) {
        ...
        for (Meta.ModelConfig.ModelInfo modelInfo : modelInfoList) {
            // 为 group，不校验
            String grouyKey = modelInfo.getGroupKey();
            if (StrUtil.isNotEmpty(grouyKey)) {
                // 生成中间参数
